...
\begin{document}
    ...
    \section*{Week 1}
    The first week of the thesis project began with geting introduced to the office and receiving a laptop that I could work on. I had the project specification finished before the course start,
    ...
    my internal supervisor and we are gonna have a meeting in the near future to talk about the uncertainties of the specification.
